            ...
            <table style="width: 100%; max-width: 500px; margin: 0 auto; background-color: #FFFFFF; padding: 20px;">
                ...
                <tr>
                    <td style="text-align: center; margin: 20px 0;">
                        ...
                        <p style="font-size: 12px; margin: 5px 0;">This email was sent to you because you signed up for a Edubridge account. If you did not sign up for an account, please ignore this email.</p>
...
const welcomeEmail = (userName) => {
  return `<body style="margin: 0; padding: 0; background-color: #F2F4F7; font-family: Arial, sans-serif;"><table style="width: 100%; max-width: 500px; margin: 0 auto; background-color: #FFFFFF; padding: 20px;">
      ...
      <p style="font-size: 24px; font-weight: bold;">Welcome to Edubridge, ${userName}!</p>
      <p style="color: #475467; font-size: 16px;">Thank you for choosing Edubridge, the app that simplifies and streamlines utility bill payments and airtime/data purchases.</p>
      <p style="color: #475467; font-size: 16px;">Edubridge is designed to provide a seamless and efficient platform for managing your essential services.</p>
      <p style="color: #475467; font-size: 16px;">With Edubridge, you can easily pay your utility bills and purchase airtime/data at your convenience, all in one place.</p>
